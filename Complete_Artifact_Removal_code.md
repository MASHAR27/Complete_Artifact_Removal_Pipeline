...
```
    ...
    Total slices: 195, showing 39 slices (every 5th)
...
![png](output_8_1.png)
    ...
    Saved tall montage: lol/1_03_P_every5th_vertical.png
...
```
    ...
    Processing 1_03_P...
    [info] kept slices [1, 194) of 195 total
    [done] saved 1_03_Pphaseone/ct_clean.nii.gz and 1_03_Pphaseone/mr_clean.nii.gz
    Cleaned volume has 193 slices; showing 39 every 5th
...
![png](output_10_1.png)
    ...
    Saved visualisation to 1_03_Pphaseone/1_03_P_cleaned_every5th.png
...
```
    ...
    Reading cleaned volumes from 1_03_Pphaseone...
    Refined -> 1_03_Pphasetwo
